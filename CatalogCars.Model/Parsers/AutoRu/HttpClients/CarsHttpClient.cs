...
namespace CatalogCars.Model.Parsers.AutoRu.HttpClients
{
    public class CarsHttpClient : BaseHttpClient
    {
        ...
        public async Task<HttpResponseMessage> GetCountCars(HeadersAjaxRequestForCars headers, RangeMileage rangeMileage, RangePrice rangePrice, int topDays, int numberPage)
        {
        ...
        public async Task<HttpResponseMessage> GetPriceRanges(HeadersAjaxRequestForCars headers, RangeMileage rangeMileage, RangePrice rangePrice, int topDays, int numberPage)
        {
            SetAjaxRequestHeaders(headers);
