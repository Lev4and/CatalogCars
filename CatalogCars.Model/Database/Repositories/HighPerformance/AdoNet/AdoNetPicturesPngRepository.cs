...
{
    public class AdoNetPicturesPngRepository : IPicturesPngRepository
    {
        private readonly CatalogCarsDbContext _context;

        public AdoNetPicturesPngRepository(CatalogCarsDbContext context)
        {
            _context = context;
        }

        public bool Save(ref PicturePng entity)
        {
            entity.Id = Guid.NewGuid();

            var query = $"INSERT INTO [PicturesPng] (Id, ExternalPanoramaId, FullFirstFrame, HighResFirstFrame, " +
