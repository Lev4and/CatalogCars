...
{
    public class AdoNetVideosWebmR16X9Repository : IVideosWebmR16X9Repository
    {
        private readonly CatalogCarsDbContext _context;

        public AdoNetVideosWebmR16X9Repository(CatalogCarsDbContext context)
        {
            _context = context;
        }

        public bool Save(ref VideoWebmR16x9 entity)
        {
