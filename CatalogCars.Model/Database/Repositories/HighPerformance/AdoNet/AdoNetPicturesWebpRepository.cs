...
{
    public class AdoNetPicturesWebpRepository : IPicturesWebpRepository
    {
        private readonly CatalogCarsDbContext _context;

        public AdoNetPicturesWebpRepository(CatalogCarsDbContext context)
        {
            _context = context;
        }

        public bool Save(ref PictureWebp entity)
        {
            entity.Id = Guid.NewGuid();

            var query = $"INSERT INTO [PicturesWebp] (Id, ExternalPanoramaId, FullFirstFrame, HighResFirstFrame, " +
