...
namespace CatalogCars.Model.Database.Migrations
{
    ...
    [Migration("20210906170528_ChangeTypePropertyYearFromFromGeneration")]
    partial class ChangeTypePropertyYearFromFromGeneration
    {
            ...
            modelBuilder.Entity("CatalogCars.Model.Database.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "4921bea4-899d-4ef9-8b72-9542e1f98c83",
                            Email = "andrey.levchenko.2001@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ANDREY.LEVCHENKO.2001@GMAIL.COM",
                            NormalizedUserName = "ADMIN",
                            PasswordHash = "AQAAAAEAACcQAAAAEN0A4gQslqWr+Ror6NQjlU4OShgCZyGNhUzF5V/y6nPUdz7+AYdLOEVUkPex5sJsqg==",
            ...
            modelBuilder.Entity("CatalogCars.Model.Database.Entities.ApplicatonRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "24f16f1d-08d0-4886-88cd-6c09272680e0",
                            Name = "Администратор",
