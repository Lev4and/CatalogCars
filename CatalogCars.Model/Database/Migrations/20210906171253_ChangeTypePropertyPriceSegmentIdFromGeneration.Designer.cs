...
namespace CatalogCars.Model.Database.Migrations
{
    ...
    [Migration("20210906171253_ChangeTypePropertyPriceSegmentIdFromGeneration")]
    partial class ChangeTypePropertyPriceSegmentIdFromGeneration
    {
            ...
            modelBuilder.Entity("CatalogCars.Model.Database.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "8a8c1531-1561-4e7a-bff4-9797a5583e32",
                            Email = "andrey.levchenko.2001@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ANDREY.LEVCHENKO.2001@GMAIL.COM",
                            NormalizedUserName = "ADMIN",
                            PasswordHash = "AQAAAAEAACcQAAAAECGykTCd6I0yKVmyWtSfD0Uqxyh1Q/L412VfR2ziFwUWehEgrhSj8WZ/l/YNmpuGNQ==",
            ...
            modelBuilder.Entity("CatalogCars.Model.Database.Entities.ApplicatonRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "9b9f4b9a-2298-4c70-be7a-af5804e1c27b",
                            Name = "Администратор",
