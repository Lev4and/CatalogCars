...
namespace CatalogCars.Model.Database.Migrations
{
    ...
    [Migration("20210906143739_ChangeTypePropertyRegionIdFromLocation")]
    partial class ChangeTypePropertyRegionIdFromLocation
    {
            ...
            modelBuilder.Entity("CatalogCars.Model.Database.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b8b01008-1e33-4c27-82f2-6f6b3c9664a7",
                            Email = "andrey.levchenko.2001@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ANDREY.LEVCHENKO.2001@GMAIL.COM",
                            NormalizedUserName = "ADMIN",
                            PasswordHash = "AQAAAAEAACcQAAAAEEYxQJLDLRi8MYIbRc5DLBI5wqxl08JjeuQR40StpXXm0+kofjfWkPHvVnbAn2OaSA==",
            ...
            modelBuilder.Entity("CatalogCars.Model.Database.Entities.ApplicatonRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "577c8155-60b5-485f-ab52-dde00368761a",
                            Name = "Администратор",
