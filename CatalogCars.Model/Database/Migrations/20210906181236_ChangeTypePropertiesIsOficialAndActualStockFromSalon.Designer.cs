...
namespace CatalogCars.Model.Database.Migrations
{
    ...
    [Migration("20210906181236_ChangeTypePropertiesIsOficialAndActualStockFromSalon")]
    partial class ChangeTypePropertiesIsOficialAndActualStockFromSalon
    {
            ...
            modelBuilder.Entity("CatalogCars.Model.Database.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b394bf2a-ce11-4d31-b6fc-c94fca4959c5",
                            Email = "andrey.levchenko.2001@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ANDREY.LEVCHENKO.2001@GMAIL.COM",
                            NormalizedUserName = "ADMIN",
                            PasswordHash = "AQAAAAEAACcQAAAAEAKAprUi3xQLf+224mFd7uD7bS8jc8IsdGl5bASR8On/vlemQZSI+PT1ut243k0gtA==",
            ...
            modelBuilder.Entity("CatalogCars.Model.Database.Entities.ApplicatonRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "906870ae-0808-4934-98f2-1d96aea2e3d8",
                            Name = "Администратор",
