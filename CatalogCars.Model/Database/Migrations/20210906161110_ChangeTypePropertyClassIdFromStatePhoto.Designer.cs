...
namespace CatalogCars.Model.Database.Migrations
{
    ...
    [Migration("20210906161110_ChangeTypePropertyClassIdFromStatePhoto")]
    partial class ChangeTypePropertyClassIdFromStatePhoto
    {
            ...
            modelBuilder.Entity("CatalogCars.Model.Database.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "9ca65835-4827-4de5-ad1e-5b54112e3290",
                            Email = "andrey.levchenko.2001@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ANDREY.LEVCHENKO.2001@GMAIL.COM",
                            NormalizedUserName = "ADMIN",
                            PasswordHash = "AQAAAAEAACcQAAAAEKKLJJLhnKX9RrUv/b4OBwoI8HTQzud5BRTwmwI/vmGGHpx0tc7UkWhY2P0nICojBQ==",
            ...
            modelBuilder.Entity("CatalogCars.Model.Database.Entities.ApplicatonRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "cace9a02-ed06-4ef8-bac3-b0a54ad1998a",
                            Name = "Администратор",
