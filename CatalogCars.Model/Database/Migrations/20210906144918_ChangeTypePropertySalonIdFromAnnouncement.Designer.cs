...
namespace CatalogCars.Model.Database.Migrations
{
    ...
    [Migration("20210906144918_ChangeTypePropertySalonIdFromAnnouncement")]
    partial class ChangeTypePropertySalonIdFromAnnouncement
    {
            ...
            modelBuilder.Entity("CatalogCars.Model.Database.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "7fc3728c-b729-4476-8f21-1fae02b1e151",
                            Email = "andrey.levchenko.2001@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ANDREY.LEVCHENKO.2001@GMAIL.COM",
                            NormalizedUserName = "ADMIN",
                            PasswordHash = "AQAAAAEAACcQAAAAEAmgk4fJzoWgaQnJGdVnUs38QTVG6QraZv8LSqKlLntlMUHdMzfG7msTOZIhTw84KQ==",
            ...
            modelBuilder.Entity("CatalogCars.Model.Database.Entities.ApplicatonRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "ce13e6ce-1eff-4774-b5e3-af29aff90b72",
                            Name = "Администратор",
