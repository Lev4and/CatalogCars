...
{
    public class AnnouncementsOnlineSearchSaveViewModel
    {
        ...
        public AnnouncementsOnlineSearchSaveViewModel()
        {
                ...
                if (!cancellationToken.IsCancellationRequested)
                {
                    ...
                    if (announcements.Count > 0)
                    {
                        foreach (var announcement in announcements)
                        {
                            ...
                            await _importRequester.SaveAnnouncementAsync(announcement);
                        }
                    }
                }
                else
